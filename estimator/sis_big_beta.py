...
def log2_lift_proportion_exact(n_q, sq_radius, q):
    ...
    EXAMPLES::
        ...
        >>> from estimator.sis_big_beta import log2_lift_proportion_exact
...
def log2_lift_proportion(n_q, sq_radius, q):
    ...
    EXAMPLES::
        ...
        >>> from estimator.sis_big_beta import log2_lift_proportion, log2_lift_proportion_exact
    ...
    def __call__(
        ...
        **kwds,
        ...
        euclidean norm is used; outside of it ``rop`` is infinite::
            ...
            >>> SIS.big_beta(params.updated(length_bound=200))
            rop: ≈2^inf, tag: big_beta
        ...
        Logging.log("big_beta", log_level, f"{cost!r}")
